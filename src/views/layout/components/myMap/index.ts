...
// const staffImgs: any = {
//   'dispatch': `@img/staffLegend/督办人员@3x.png`,
//   'manage': `@img/staffLegend/管理@3x.png`,
//   'clean': `@img/staffLegend/运维@3x.png`,
//   'clean-1006': `@img/staffLegend/摩拜运维@3x.png`,
//   'clean-1007': `@img/staffLegend/OFO运维@3x.png`,
//   'clean-1015': `@img/staffLegend/哈罗运维@3x.png`,
//   'clean-1059': `@img/staffLegend/享骑运维@3x.png`,
//   'clean-1014': `@img/staffLegend/赳赳运维@3x.png`,
//   'manage-1006': `@img/staffLegend/摩拜管理人员@3x.png`,
//   'manage-1007': `@img/staffLegend/OFO管理人员@3x.png`,
//   'manage-1015': `@img/staffLegend/哈罗管理人员@3x.png`,
//   'manage-1059': `@img/staffLegend/享骑管理人员@3x.png`,
//   'manage-1014': `@img/staffLegend/赳赳管理人员@3x.png`,
// };
...
export default class Map extends Vue {
  ...
  // private legendData: Array<{ icon: any; name: string }> = [
  //   {
  //     icon: require(`@img/staffLegend/icon_1@3x.png`),
  //     name: '自检',
  //   },
  //   {
  //     icon: require(`@img/staffLegend/icon_2@3x.png`),
  //     name: '已派单',
  //   },
  //   {
  //     icon: require(`@img/staffLegend/icon_3@3x.png`),
  //     name: '处理中',
  //   },
  //   {
  //     icon: require(`@img/staffLegend/icon_4@3x.png`),
  //     name: '已处理',
  //   },
  //   {
  //     icon: `/staffLegend/icon_5@3x.png`,
  //     name: '超时未处理',
  //   },
  // ];
